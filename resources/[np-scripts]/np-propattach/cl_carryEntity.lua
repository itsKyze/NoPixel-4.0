    ...
    exports["interactions"]:AddVehicleInteraction({
        ...
        context = {
            ...
            isEnabled = function(pEntity)
                ...
                return IsThisModelABicycle(model) and not IsEntityAttachedToAnyPed(pEntity) and
                    not IsEntityAttachedToAnyPed(PlayerPedId()) and GetVehicleDoorLockStatus(pEntity) ~= 2 and
                    GetPedInVehicleSeat(pEntity, -1) == 0
            end,
        },
    })
end)
