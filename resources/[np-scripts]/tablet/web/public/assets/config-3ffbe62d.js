import { c as _0x2f11ac, a as _0x1bb3ce, J as _0x57f250, e as _0x5b7a08, f as _0x51a861, j as _0x201707, k as _0x2b481b, l as _0x1dab7c, y as _0x533b0d, S as _0x3bc714, t as _0x26f201, n as _0x1d13f7, m as _0x5efbf6, Q as _0x469937, M as _0x15f188, w as _0x5e4060, ag as _0x5478c8 } from "./vendor-c69496a3.js";
import { b as _0x13f154, a as _0x3f8ca1 } from "./vite-1e207deb.js";
import { T as _0x42280c } from "./index-dc6786b9.js";
import { N as _0x5b6a32, a as _0x29482e } from "./v-packages-3113361c.js";
import "./commonjsHelpers-725317a4.js";
const q = "" + new URL("salty-icon-0c18c9e1.png", import.meta.url).href;
const J = "_container_ia802_1";
const Q = {
  container: J
};
const z = "_table_1jvye_1";
const X = "_rectangle_1jvye_23";
const e2 = "_easy_1jvye_29";
const t2 = "_hard_1jvye_32";
const n2 = "_medium_1jvye_35";
const i2 = "_difficulty_1jvye_39";
const s2 = "_progress_container_1jvye_61";
const r2 = "_bar_1jvye_71";
const a2 = "_progress_1jvye_61";
const o2 = "_seconds_1jvye_84";
const g = {
  table: z,
  rectangle: X,
  easy: e2,
  ...
  medium: n2,
  difficulty: i2,
  progress_container: s2,
  bar: r2,
  progress: a2,
  seconds: o2
};
const l2 = _0x26f201("<div class=\"flex flex-row items-center justify-center gap-[1vh]\"><div class=\"flex flex-row items-center justify-center gap-[0.5vh]\"></div><div>");
const C2 = _0x26f201("<div>");
const c2 = _0x26f201("<div><div class=\"pointer-events-none absolute flex h-[80%] w-full flex-row items-end justify-center gap-[0.5vh] px-[18vh]\"><div><div><div></div></div></div><div> sec left");
const d2 = () => {
  const {
    setPage: _0x4fffbc
  } = B();
  ...
  const [_0x5d423d, _0x1d1412] = _0x2f11ac([]);
  const _0x552b7b = [{
    accessorKey: "mac",
    header: "MAC Address",
    cell: _0x43bd47 => _0x43bd47.getValue()
  }, {
    accessorKey: "ip",
    header: "IP Address"
  }, {
    ...
    header: "Security",
    cell: _0x37fa2c => _0x37fa2c.getValue()
  }];
  const [_0xea775d, _0x111451] = _0x1bb3ce(15);
  _0x57f250(async () => {
    const _0x455803 = await _0x5b6a32.execute("salty:getWifiList");
    const _0x281fab = setInterval(() => {
      _0x111451(_0xea775d() - 1);
    }, 1000);
    setTimeout(() => {
      clearInterval(_0x281fab);
      _0x4fffbc("scan");
    }, 15000);
    const _0x1c9445 = [];
    for (const _0x461c50 of _0x455803) {
      _0x1c9445.push({
        ..._0x461c50,
        security: (() => {
          const _0x1afe15 = l2();
          const _0x39949e = _0x1afe15.firstChild;
          const _0x3fd3b7 = _0x39949e.nextSibling;
          _0x5b7a08(_0x39949e, _0x51a861(_0x533b0d, {
            get each() {
              return [...Array(_0x372081).keys()];
            },
            children: _0x24c1b0 => (() => {
              const _0x2cf643 = C2();
              _0x201707(_0x395dc4 => {
                const _0x3d95c1 = g.rectangle;
                const _0x526dc0 = {
                  [g[_0x461c50.type]]: _0x24c1b0 < _0xbfac41[_0x461c50.type]
                };
                if (_0x3d95c1 !== _0x395dc4._v$3) {
                  _0x2b481b(_0x2cf643, _0x395dc4._v$3 = _0x3d95c1);
                }
                _0x395dc4._v$4 = _0x1dab7c(_0x2cf643, _0x526dc0, _0x395dc4._v$4);
                return _0x395dc4;
              }, {
                _v$3: undefined,
                _v$4: undefined
          ...
          _0x5b7a08(_0x3fd3b7, () => _0x2b18e3[_0x461c50.type]);
          _0x201707(_0x14c6d8 => {
            const _0x4e4b98 = g.difficulty;
            const _0x13e371 = {
              [g[_0x461c50.type]]: true
            };
            if (_0x4e4b98 !== _0x14c6d8._v$) {
              _0x2b481b(_0x3fd3b7, _0x14c6d8._v$ = _0x4e4b98);
            }
            _0x14c6d8._v$2 = _0x1dab7c(_0x3fd3b7, _0x13e371, _0x14c6d8._v$2);
            return _0x14c6d8;
          }, {
            _v$: undefined,
            _v$2: undefined
    ...
    _0x1d1412(_0x1c9445.sort((_0x34bccf, _0x5d0e67) => _0x34bccf.type === "easy" ? -1 : _0x5d0e67.type === "easy" ? 1 : _0x34bccf.type === "medium" ? -1 : _0x5d0e67.type === "medium" ? 1 : 0));
  });
  return (() => {
    const _0x1cb59d = c2();
    const _0x22040d = _0x1cb59d.firstChild;
    const _0x1f80de = _0x22040d.firstChild;
    const _0x7a0f7c = _0x1f80de.firstChild;
    const _0x3177e2 = _0x7a0f7c.firstChild;
    const _0x36df99 = _0x1f80de.nextSibling;
    const _0x48d6ba = _0x36df99.firstChild;
    _0x5b7a08(_0x1cb59d, _0x51a861(_0x3bc714, {
      get when() {
        return _0x5d423d.length !== 0;
      },
      get children() {
        return _0x51a861(_0x42280c, {
          rows: _0x5d423d,
          columns: _0x552b7b
        });
      }
    }), _0x22040d);
    _0x5b7a08(_0x36df99, _0xea775d, _0x48d6ba);
    _0x201707(_0x348468 => {
      const _0x18fd88 = g.table;
      const _0x22f203 = g.progress_container;
      const _0x3f8262 = g.bar;
      const _0x129411 = g.progress;
      const _0x1fb481 = _0xea775d() / 15 * 100 + "%";
      const _0x556943 = g.seconds;
      if (_0x18fd88 !== _0x348468._v$5) {
        _0x2b481b(_0x1cb59d, _0x348468._v$5 = _0x18fd88);
      }
      if (_0x22f203 !== _0x348468._v$6) {
        _0x2b481b(_0x1f80de, _0x348468._v$6 = _0x22f203);
      }
      if (_0x3f8262 !== _0x348468._v$7) {
        _0x2b481b(_0x7a0f7c, _0x348468._v$7 = _0x3f8262);
      }
      if (_0x129411 !== _0x348468._v$8) {
        _0x2b481b(_0x3177e2, _0x348468._v$8 = _0x129411);
      }
      if (_0x1fb481 !== _0x348468._v$9) {
        if ((_0x348468._v$9 = _0x1fb481) != null) {
          _0x3177e2.style.setProperty("width", _0x1fb481);
        } else {
          _0x3177e2.style.removeProperty("width");
        }
      }
      if (_0x556943 !== _0x348468._v$10) {
        _0x2b481b(_0x36df99, _0x348468._v$10 = _0x556943);
      }
      return _0x348468;
    }, {
      _v$5: undefined,
...
const f2 = "_container_1fkan_1";
const _2 = "_info_1fkan_8";
const v2 = "_iconBox_1fkan_20";
const L2 = "_scan_1fkan_48";
const u2 = "_stop_1fkan_70";
const h2 = "_crypto_1fkan_77";
const g2 = "_triangle_1fkan_94";
const $ = {
  container: f2,
  info: _2,
  iconBox: v2,
...
const p2 = "_container_8rd2g_1";
const y2 = "_content_8rd2g_7";
const m2 = "_animation_8rd2g_15";
const $2 = "_scan_8rd2g_1";
const A = {
  container: p2,
  content: y2,
  animation: m2,
...
const x2 = () => {
  ...
  return (() => {
    const _0x1ebb8a = w2();
    const _0x2a5465 = _0x1ebb8a.firstChild;
    const _0x1e1822 = _0x2a5465.nextSibling;
    const _0x387143 = _0x1e1822.firstChild;
    const _0x17fef0 = _0x387143.nextSibling;
    const _0x4be46a = _0x17fef0.firstChild;
    const _0x5022f3 = _0x4be46a.nextSibling;
    _0x5b7a08(_0x4be46a, () => _0x21fed7() ? "Scanning..." : "Waiting for Scanning...");
    _0x5b7a08(_0x5022f3, () => _0x21fed7() ? "It will take some time." : "Please, start scanning");
    _0x201707(_0x551a74 => {
      const _0x59d592 = A.container;
      const _0x5675f1 = A.content;
      const _0x3adcb8 = "" + (_0x21fed7() && A.animation);
      if (_0x59d592 !== _0x551a74._v$) {
        _0x2b481b(_0x1ebb8a, _0x551a74._v$ = _0x59d592);
      }
      if (_0x5675f1 !== _0x551a74._v$2) {
        _0x2b481b(_0x1e1822, _0x551a74._v$2 = _0x5675f1);
      }
      if (_0x3adcb8 !== _0x551a74._v$3) {
        _0x1d13f7(_0x387143, "class", _0x551a74._v$3 = _0x3adcb8);
      }
      return _0x551a74;
    }, {
      _v$: undefined,
...
const k2 = () => {
  ...
  _0x469937(() => {
    if (_0x2705d3()) {
      ...
      }, _0x29482e.MathUtils.getRandomNumber(2500, 5000));
    }
  }, [_0x2705d3()]);
  return (() => {
    const _0x8f90 = S2();
    const _0x4589dc = _0x8f90.firstChild;
    const _0x4bad5f = _0x4589dc.firstChild;
    const _0x4cd259 = _0x4589dc.nextSibling;
    const _0x41fc06 = _0x4cd259.firstChild;
    const _0x464618 = _0x41fc06.nextSibling;
    const _0x1cecc3 = _0x464618.nextSibling;
    const _0x4ed5b1 = _0x1cecc3.nextSibling;
    _0x5b7a08(_0x8f90, _0x51a861(x2, {}), _0x4589dc);
    _0x464618.$$click = async () => {
      if (!(await _0x5b6a32.execute("salty:scanWifi"))) {
        _0x13f154("salty", "You don't have enough crypto to scan this network.");
        return;
      }
      _0x13f154("salty", "You paid 1 crypto, scanning...");
      _0x4fdc5c(!_0x2705d3());
    };
    _0x5b7a08(_0x464618, () => _0x2705d3() ? "Cancel" : "Scan");
    _0x201707(_0x12c4db => {
      const _0x2931bb = $.container;
      const _0x2f5897 = $.info;
      const _0x3fdc5f = $.iconBox;
      const _0x1b4292 = $.triangle;
      const _0x7a958a = $.scan;
      const _0xce9770 = {
        [$.stop]: _0x2705d3()
      };
      const _0xce635d = $.crypto;
      const _0x1fd1d6 = $.triangle;
      if (_0x2931bb !== _0x12c4db._v$) {
        _0x2b481b(_0x8f90, _0x12c4db._v$ = _0x2931bb);
      }
      if (_0x2f5897 !== _0x12c4db._v$2) {
        _0x2b481b(_0x4589dc, _0x12c4db._v$2 = _0x2f5897);
      }
      if (_0x3fdc5f !== _0x12c4db._v$3) {
        _0x2b481b(_0x4bad5f, _0x12c4db._v$3 = _0x3fdc5f);
      }
      if (_0x1b4292 !== _0x12c4db._v$4) {
        _0x1d13f7(_0x41fc06, "class", _0x12c4db._v$4 = _0x1b4292);
      }
      if (_0x7a958a !== _0x12c4db._v$5) {
        _0x2b481b(_0x464618, _0x12c4db._v$5 = _0x7a958a);
      }
      _0x12c4db._v$6 = _0x1dab7c(_0x464618, _0xce9770, _0x12c4db._v$6);
      if (_0xce635d !== _0x12c4db._v$7) {
        _0x2b481b(_0x1cecc3, _0x12c4db._v$7 = _0xce635d);
      }
      if (_0x1fd1d6 !== _0x12c4db._v$8) {
        _0x1d13f7(_0x4ed5b1, "class", _0x12c4db._v$8 = _0x1fd1d6);
      }
      return _0x12c4db;
    }, {
      _v$: undefined,
...
const B2 = () => {
  ...
  return (() => {
    const _0x5a841d = M2();
    _0x5b7a08(_0x5a841d, _0x51a861(_0x3f8ca1, {
      get name() {
        return j2.name;
      }
    }), null);
    _0x5b7a08(_0x5a841d, _0x51a861(_0x5e4060, {
      get children() {
        return [_0x51a861(_0x15f188, {
          get when() {
            return _0x25219c() === "scan";
          },
          get children() {
            return _0x51a861(k2, {});
          }
    ...
    _0x201707(() => _0x2b481b(_0x5a841d, Q.container));
    return _0x5a841d;
  })();
};
const [b2, A2] = _0x5478c8(() => {
  const [_0x51d5ca, _0x4c2f8b] = _0x1bb3ce(false);
  const [_0x569db5, _0x2f0756] = _0x1bb3ce("scan");
  return {
    scan: _0x51d5ca,
    setScan: _0x4c2f8b,
    page: _0x569db5,
