...
Citizen.CreateThread(function()
    ...
    exports["interactions"]:AddInteractionByModel({ 'prop_parknmeter_02', 'prop_parknmeter_01' }, {
...
function DeleteEntityAtCoords(pModel, pCoords)
    local object = GetClosestObjectOfType(pCoords.x, pCoords.y, pCoords.z, 1.0, pModel, false, false, false)
