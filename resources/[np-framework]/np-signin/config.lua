...
MenuData = {
  ...
  public_services_sign_in = {
    ...
    },
    {
      ...
      key = "city_council",
      children = {
          { i18nTitle = true, i18nDescription = true, title = _L("signin-sign-in", "Sign In"), action = "np-signin:handler", key = { sign_in = true, job = "city_council" } },
          { i18nTitle = true, i18nDescription = true, title = _L("signin-sign-out", "Sign Out"), action = "np-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "treasurer",
      children = {
          { i18nTitle = true, i18nDescription = true, title = _L("signin-sign-in", "Sign In"), action = "np-signin:handler", key = { sign_in = true, job = "treasurer" } },
          { i18nTitle = true, i18nDescription = true, title = _L("signin-sign-out", "Sign Out"), action = "np-signin:handler", key = { sign_off = true } }
      }
    },
    {
    ...
    },
    {
      ...
      key = "SAMA Director",
      children = {
        { i18nTitle = true, i18nDescription = true, title = _L("signin-sign-in", "Sign In"), action = "np-signin:handler", key = { sign_in = true, job = "sama_director" } },
        { i18nTitle = true, i18nDescription = true, title = _L("signin-sign-out", "Sign Out"), action = "np-signin:handler", key = { sign_off = true } }
      }
    }
  },
