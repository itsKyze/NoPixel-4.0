...
AddEventHandler('np-config:configLoaded', function (pId, pConfig)
    ...
    ModuleConfig = pConfig or { useScopeSize = false }
...
function StartProximityThread()
    ...
    Citizen.CreateThread(function ()
        while ScanningNearby do
            ...
            Citizen.Wait((ModuleConfig and ModuleConfig.updateInterval) or 500)
        end
    end)
end
...
function LoadProximityModule()
    ...
    Citizen.CreateThread(function ()
        ...
        ModuleConfig = exports['config']:GetModuleConfig('np-voice') or { updateInterval = 500, useScopeSize = false }
        ...
        for _, player in ipairs(players) do
            ...
            if ModuleConfig and ModuleConfig.useScopeSize then
                data['targeted'] = true
        ...
        if ModuleConfig and ModuleConfig.useScopeSize then return end
