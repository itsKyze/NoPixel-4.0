        ...
        if (item.runProgress === true) {
            ...
            if (item.colorsent == 2) {
                element = $(
                    '<div id="colorsent' +
                        item.colorsent +
                        '" class="notification-bg red" style="display:none" data-total-time="' +
                        fadetimer +
                        '"><i class="icon">' +
                        errorSvg +
                        '</i>' +
                ...
                element = $(
                    '<div id="colorsent' +
                        item.colorsent +
                        '" class="notification-bg taxi" style="display:none" data-total-time="' +
                        fadetimer +
                        '"><i class="icon">' +
                        warningSvg +
                        '</i>' +
                ...
                element = $(
                    '<div id="colorsent' +
                        item.colorsent +
                        '" class="notification-bg medical" style="display:none" data-total-time="' +
                        fadetimer +
                        '"><i class="icon">' +
                        warningSvg +
                        '</i>' +
                ...
                element = $(
                    '<div id="colorsent' +
                        item.colorsent +
                        '" class="notification-bg normal" style="display:none" data-total-time="' +
                        fadetimer +
                        '"><i class="icon">' +
                        infoSvg +
                        '</i>' +
