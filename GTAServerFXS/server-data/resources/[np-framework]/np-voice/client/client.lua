...
RegisterNetEvent('playerstate:isUnderWater', function(pState)
    IsUnderwater = pState
    if IsUnderwater and IsRadioOn then
...
Citizen.CreateThread(function()
    exports["np-keybinds"]:registerKeyMapping("", "Voice", "Proximity / Range Toggle", "+cycleProximity", "-cycleProximity", "Z", nil, nil, true)
