(() => {
  ...
  const varData_10 = null && varData_2;
  ;
  ...
  async function handleAction_7(param_1) {
    ...
    const varData_14 = CFX.setTimeout(() => isDisabled_1 = true, 60000);
    while (!CFX.HasModelLoaded(varData_13) && !isDisabled_1) {
      await Wait(10);
    }
    CFX.clearTimeout(varData_14);
    return isDisabled_1 === false;
  }
  ...
  async function handleAction_10() {
    try {
      ...
      setTimeout(() => handleAction_10(), 10000);
    }
  }
  ...
  class _0x427cf9 {
    ...
    addHook(param_1, param_2) {
      var varData_40;
      if ((varData_40 = this.hooks.get(param_1)) === null || varData_40 === undefined) {
        undefined;
      } else {
  ...
  ;
  const varData_41 = new _0x427cf9(function () {}, 1000, "tick");
