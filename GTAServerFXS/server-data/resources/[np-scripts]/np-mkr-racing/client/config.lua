config = {
  ...
  checkpointBlipLookahead = 6, -- How many checkpoints after the current to create a blip for
  checkpointPropLookahead = 6, -- How many checkpoints after the current to spawn props (checkpointObjectHash) for
  checkpointUseMultiColorProp = true, -- Whether to use multiple props for checkpoints, needs to be 3, current -> next -> rest of visible props
...
config.startObjectHash = `np_prop_cpflag` --  prop_beachflag_01 Hash of the object that spawn to the left and right of the start of the race
