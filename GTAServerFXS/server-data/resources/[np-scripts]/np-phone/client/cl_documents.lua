...
RegisterNetEvent('np-phone:documents:receivedDocument')
AddEventHandler('np-phone:documents:receivedDocument', function()
  TriggerEvent('phone:notification', 'Documents', 'A new document has been shared with you!', true, 'documents')
end)
