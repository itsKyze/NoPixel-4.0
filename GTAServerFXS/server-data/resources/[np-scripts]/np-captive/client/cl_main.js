(() => {
  ...
  ;
  let _0x5dd4c7;
  const _0x39ae86 = /* @__PURE__ */ new Map();
  ...
  class _0x22f0e5 {
    ...
    addHook(_0xabe0a6, _0x2761ad) {
      var _0x523da5;
      if ((_0x523da5 = this.hooks.get(_0xabe0a6)) === null || _0x523da5 === void 0) {
      } else {
    ...
    canTick(_0xe4432e) {
      return this.scheduled[_0xe4432e] === void 0 || this.tick >= this.scheduled[_0xe4432e];
    }
  }
  ;
  ...
  ;
  const _0x52efe2 = /* @__PURE__ */ new Map();
  const _0x40fa11 = new _0x22f0e5(() => {
  }, 0);
  const _0x31a6c3 = {
    xPos: -0.01,
    yPos: 0.045,
    zPos: 19081958235745e-29,
    xRot: 223,
    yRot: -94,
    zRot: -52
  };
  ...
  async function _0xd6f3cb(_0x2ff769, _0x275a51, _0x59af48) {
    const _0x411c21 = new _0x44a4ae(PlayerPedId(), "normal", _0x59af48 ? _L("captive-applying", "Applying") : _L("captive-removing", "Removing"), _0x59af48 ? 1e4 : 1e3, "amb@prop_human_parking_meter@female@base", "base_female");
  ...
  const _0x1a8d84 = async (_0x3731d2) => {
    ...
    if (_0x16c909) {
      ...
      const _0x3138f3 = await _0x1657f3.waitForCondition(() => DoesEntityExist(_0x1cfa8d), 3e4);
      if (_0x3138f3) {
        return 0;
      }
      if (_0x1cfa8d) {
