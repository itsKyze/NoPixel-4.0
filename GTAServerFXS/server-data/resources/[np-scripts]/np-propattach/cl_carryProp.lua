		...
		if (`WEAPON_UNARMED` ~= GetSelectedPedWeapon(PlayerPedId()) and holdingPackage) then
			if not holdingPackage then
				...
				if dst < 2 then
					...
					AttachEntityToEntity(attachedPropPerm, PlayerPedId(), APPbone, APPx, APPy, APPz, APPxR, APPyR, APPzR,
						1, 1, 0, 0, 2, 1)
				end
			else
				holdingPackage = not holdingPackage
...
AddEventHandler('attachProp', function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, pVertexIndex,
	...
	AttachEntityToEntity(attachedProp, PlayerPedId(), bone, x, y, z, xR, yR, zR, 1, 1, 0, 0,
		pVertexIndex and pVertexIndex or 2, 1)
end)
...
AddEventHandler('attachPropPoliceIdBoard', function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR)
	...
	if not IsEntityPlayingAnim(PlayerPedId(), "mp_character_creation@lineup@male_a", "loop_raised", 3) then
		...
		TaskPlayAnim(PlayerPedId(), "mp_character_creation@lineup@male_a", "loop_raised", 1.0, 1.0, animLength, 54, 0, 0,
			0, 0)
	end
	attachModel = GetHashKey(attachModelSent)
	boneNumber = boneNumberSent
...
attachPropList = {
	...
	["test"] = {
		["model"] = "prop_cs_brain_chunk", ["bone"] = 28422, ["x"] = 0.062, ["y"] = 0.02, ["z"] = 0.0, ["xR"] = 0.0,
		["yR"] = 0.0, ["zR"] = 0.0
	},

	["umbrella01"] = {
		["model"] = "p_amb_brolly_01", ["bone"] = 57005, ["x"] = 0.1, ["y"] = 0.00, ["z"] = -0.025, ["xR"] = -90.0,
		["yR"] = 0.0, ["zR"] = 0.0
	},

	["cigar1"] = {
		["model"] = "prop_cigar_01", ["bone"] = 47419, ["x"] = 0.010, ["y"] = 0.00, ["z"] = 0.0, ["xR"] = 50.0, ["yR"] = -80.0,
		["zR"] = 0.0
	},

	["cigar2"] = {
		["model"] = "prop_cigar_02", ["bone"] = 47419, ["x"] = 0.010, ["y"] = 0.00, ["z"] = 0.0, ["xR"] = 50.0, ["yR"] = -80.0,
		["zR"] = 0.0
	},

	["cigar3"] = {
		["model"] = "prop_cigar_03", ["bone"] = 47419, ["x"] = 0.010, ["y"] = 0.00, ["z"] = 0.0, ["xR"] = 50.0, ["yR"] = -80.0,
		["zR"] = 0.0
	},

	["cigarette"] = {
		["model"] = "prop_cs_ciggy_01", ["bone"] = 28422, ["x"] = -0.0, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 0.0, ["yR"] = 0.0,
		["zR"] = 0.0
	},

	["cig01"] = {
		["model"] = "prop_amb_ciggy_01", ["bone"] = 28422, ["x"] = -0.024, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 0.0, ["yR"] = 0.0,
		["zR"] = 0.0
	},

	["cig02"] = {
		["model"] = "prop_amb_ciggy_01", ["bone"] = 58867, ["x"] = 0.06, ["y"] = 0.0, ["z"] = -0.02, ["xR"] = 0.0, ["yR"] = 0.0,
		["zR"] = 90.0
	},

	["cigmouth"] = {
		["model"] = "prop_amb_ciggy_01", ["bone"] = 47419, ["x"] = 0.010, ["y"] = -0.009, ["z"] = -0.003, ["xR"] = 55.0,
		["yR"] = 0.0, ["zR"] = 110.0
	},

	["healthpack01"] = {
		["model"] = "prop_ld_health_pack", ["bone"] = 28422, ["x"] = 0.18, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 135.0,
		["yR"] = -100.0, ["zR"] = 0.0
	},

	["briefcase01"] = {
		["model"] = "prop_ld_case_01", ["bone"] = 28422, ["x"] = 0.08, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 315.0, ["yR"] = 288.0,
		["zR"] = 0.0
	},

	["cashcase01"] = {
		["model"] = "prop_cash_case_01", ["bone"] = 28422, ["x"] = 0.05, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 135.0, ["yR"] = -100.0,
		["zR"] = 0.0
	},

	["cashbag01"] = {
		["model"] = "prop_cs_heist_bag_01", ["bone"] = 24816, ["x"] = 0.15, ["y"] = -0.4, ["z"] = -0.38, ["xR"] = 90.0,
		["yR"] = 0.0, ["zR"] = 0.0
	},

	["wadofbills"] = {
		["model"] = "prop_anim_cash_pile_01", ["bone"] = 60309, ["x"] = 0.0, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 180.0,
		["yR"] = 0.0, ["zR"] = 70.0
	},

	["notepad01"] = {
		["model"] = "prop_notepad_01", ["bone"] = 60309, ["x"] = 0.0, ["y"] = -0.0, ["z"] = -0.0, ["xR"] = 0.0, ["yR"] = 0.0,
		["zR"] = 0.0
	},
 
	["np_phone_black"] = {
		["model"] = "np_phone_black", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},

	["np_phone_green"] = {
		["model"] = "np_phone_green", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},
	
	["np_phone_blue"] = {
		["model"] = "np_phone_blue", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},
	
	["np_phone_orange"] = {
		["model"] = "np_phone_orange", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},
	
	["np_phone_pink"] = {
		["model"] = "np_phone_pink", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},
	
	["np_phone_purple"] = {
		["model"] = "np_phone_purple", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},
	
	["np_phone_red"] = {
		["model"] = "np_phone_red", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},
	
	["np_phone_yellow"] = {
		["model"] = "np_phone_yellow", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},

	["np_phone_white"] = {
		["model"] = "np_phone_white", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},

	["radio01"] = {
		["model"] = "prop_cs_hand_radio", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 110.0,
		["yR"] = 120.0, ["zR"] = -15.0
	},
	["radio_civ"] = {
		["model"] = "np_radio_civ", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.01, ["z"] = -0.02, ["xR"] = 180.0, ["yR"] = 30.0,
		["zR"] = 90.0
	},

	["clipboard01"] = {
		["model"] = "p_amb_clipboard_01", ["bone"] = 60309, ["x"] = -0.01, ["y"] = -0.015, ["z"] = 0.005, ["xR"] = 0.0,
		["yR"] = 0.0, ["zR"] = -10.0
	},
	["clipboard02"] = {
		["model"] = "p_amb_clipboard_01", ["bone"] = 60309, ["x"] = 0.1, ["y"] = -0.01, ["z"] = 0.005, ["xR"] = -95.0,
		["yR"] = 20.0, ["zR"] = -20.0
	},


	["tablet01"] = {
		["model"] = "prop_cs_tablet", ["bone"] = 60309, ["x"] = 0.02, ["y"] = -0.01, ["z"] = -0.03, ["xR"] = 0.0, ["yR"] = 0.0,
		["zR"] = -10.0
	},

	["binder01"] = {
		["model"] = "np_npc_binder", ["bone"] = 60309, ["x"] = 0.1, ["y"] = 0.025, ["z"] = -0.15, ["xR"] = 0.0, ["yR"] = 100.0,
		["zR"] = -90.0
	},

	["npolaroid_photobook"] = {
		["model"] = "np_poly_binder", ["bone"] = 60309, ["x"] = 0.1, ["y"] = 0.025, ["z"] = -0.15, ["xR"] = 0.0, ["yR"] = 100.0,
		["zR"] = -90.0
	},

	["openBook"] = {
		["model"] = "v_ilev_mp_bedsidebook", ["bone"] = 60309, ["x"] = 0.05, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = -90.0,
		["yR"] = 0.0, ["zR"] = 0.0
	},

	["pencil01"] = {
		["model"] = "prop_pencil_01", ["bone"] = 58870, ["x"] = 0.04, ["y"] = 0.0225, ["z"] = 0.08, ["xR"] = 320.0,
		["yR"] = 0.0, ["zR"] = 220.0
	},

	["drugpackage01"] = {
		["model"] = "prop_meth_bag_01", ["bone"] = 28422, ["x"] = 0.1, ["y"] = 0.0, ["z"] = -0.01, ["xR"] = 135.0, ["yR"] = -100.0,
		["zR"] = 40.0
	},

	["drugpackage02"] = {
		["model"] = "prop_weed_bottle", ["bone"] = 28422, ["x"] = 0.09, ["y"] = 0.0, ["z"] = -0.03, ["xR"] = 135.0,
		["yR"] = -100.0, ["zR"] = 40.0
	},

	["drugtest01"] = {
		["model"] = "prop_cash_case_02", ["bone"] = 28422, ["x"] = -0.01, ["y"] = -0.1, ["z"] = -0.138, ["xR"] = 0.0,
		["yR"] = 0.0, ["zR"] = 0.0
	},
	...
	["hammer"] = {
		["model"] = "w_me_hammer", ["bone"] = 28422, ["x"] = 0.0054,["y"] = 0.0051,["z"] = -0.1172,["xR"] = 0.0460,["yR"] = 9.4675, ["zR"] = 180.3062
	},

	["sledgehammer"] = {
		["model"] = "w_me_pdsledge", ["bone"] = 60309, ["x"] = 0.0,["y"] = -0.0,["z"] = -0.0,["xR"] = 0.0,["yR"] = 0.0, ["zR"] = 0.0
	},

	["bomb01"] = {
		["model"] = "prop_ld_bomb", ["bone"] = 28422, ["x"] = 0.22, ["y"] = -0.01, ["z"] = 0.0, ["xR"] = -25.0, ["yR"] = -100.0,
		["zR"] = 0.0
	},

	["spraycan"] = {
		["model"] = "prop_paint_spray01b", ["bone"] = 28422, ["x"] = 0.02, ["y"] = -0.02, ["z"] = -0.1, ["xR"] = 0.0,
		["yR"] = 0.0, ["zR"] = 0.0
	},

	["money01"] = {
		["model"] = "prop_anim_cash_note", ["bone"] = 28422, ["x"] = 0.1, ["y"] = 0.04, ["z"] = 0.0, ["xR"] = 25.0,
		["yR"] = 0.0, ["zR"] = 10.0
	},

	["armor01"] = {
		["model"] = "prop_armour_pickup", ["bone"] = 28422, ["x"] = 0.3, ["y"] = 0.01, ["z"] = 0.0, ["xR"] = 255.0,
		["yR"] = -90.0, ["zR"] = 10.0
	},

	["terd01"] = {
		["model"] = "prop_big_shit_01", ["bone"] = 61839, ["x"] = 0.015, ["y"] = 0.0, ["z"] = -0.01, ["xR"] = 3.0, ["yR"] = -90.0,
		["zR"] = 180.0
	},

	["blackduffelbag"] = {
		["model"] = "xm_prop_x17_bag_01a", ["bone"] = 28422, ["x"] = 0.37, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = -50.0,
		["yR"] = -90.0, ["zR"] = 0.0
	},

	["medicalBag"] = {
		["model"] = "xm_prop_x17_bag_med_01a", ["bone"] = 28422, ["x"] = 0.37, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = -50.0,
		["yR"] = -90.0, ["zR"] = 0.0
	},

	["securityCase"] = {
		["model"] = "prop_security_case_01", ["bone"] = 28422, ["x"] = 0.1, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = -50.0,
		["yR"] = -90.0, ["zR"] = 0.0
	},

	["toolbox"] = {
		["model"] = "prop_tool_box_04", ["bone"] = 28422, ["x"] = 0.37, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = -50.0, ["yR"] = -90.0,
		["zR"] = 0.0
	},

	["guitarCase"] = {
		["model"] = "sf_prop_sf_guitar_case_01a_np", ["bone"] = 28422, ["x"] = 0.29, ["y"] = -0.06, ["z"] = -0.18, ["xR"] = 35.0,
		["yR"] = 0.0, ["zR"] = 0.0
	},

	["np_prop_cs_walking_stick"] = {
		["model"] = "np_prop_cs_walking_stick", ["bone"] = 60309, ["x"] = 0.075, ["y"] = 0.03, ["z"] = 0.00, ["xR"] = 160.0,
		["yR"] = 255.0, ["zR"] = 0.0
	},

	["boombox01"] = {
		["model"] = "prop_boombox_01", ["bone"] = 28422, ["x"] = 0.2, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = -35.0, ["yR"] = -100.0,
		["zR"] = 0.0
	},

	["bowlball01"] = {
		["model"] = "prop_bowling_ball", ["bone"] = 28422, ["x"] = 0.12, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 75.0, ["yR"] = 280.0,
		["zR"] = -80.0
	},

	["bowlpin01"] = {
		["model"] = "prop_bowling_pin", ["bone"] = 28422, ["x"] = 0.12, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 75.0, ["yR"] = 280.0,
		["zR"] = -80.0
	},

	["crate01"] = {
		["model"] = "prop_cs_cardbox_01", ["bone"] = 28422, ["x"] = 0.0, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 0.0, ["yR"] = 0.0,
		["zR"] = 0.0
	},

	["tvcamera01"] = {
		["model"] = "prop_v_cam_01", ["bone"] = 57005, ["x"] = 0.13, ["y"] = 0.25, ["z"] = -0.03, ["xR"] = -85.0, ["yR"] = 0.0,
		["zR"] = -80.0
	},

	["boomMIKE01"] = {
		["model"] = "prop_v_bmike_01", ["bone"] = 57005, ["x"] = 0.1, ["y"] = 0.0, ["z"] = -0.03, ["xR"] = 85.0, ["yR"] = 0.0,
		["zR"] = 96.0
	},
	["props_news_boommic"] = {
		["model"] = "props_news_boommic", ["bone"] = 57005, ["x"] = 0.1, ["y"] = 0.0, ["z"] = -0.03, ["xR"] = 85.0,
		["yR"] = 0.0, ["zR"] = 96.0
	},

	["minigameThermite"] = {
		["model"] = "prop_oiltub_06", ["bone"] = 57005, ["x"] = 0.1, ["y"] = 0.0, ["z"] = -0.09, ["xR"] = 145.0, ["yR"] = 20.0,
		["zR"] = 80.0
	},
	["drill"] = {
		["model"] = "imp_prop_drill_01a", ["bone"] = 60309, ["x"] = 0.172, ["y"] = -0.14, ["z"] = 0.012, ["xR"] = 1.0,
		["yR"] = 90.0, ["zR"] = 90.0
	},
	["minigameDrill"] = {
		["model"] = "hei_prop_heist_drill", ["bone"] = 57005, ["x"] = 0.15, ["y"] = 0.0, ["z"] = -0.05, ["xR"] = 0.0,
		["yR"] = 90.0, ["zR"] = 90.0
	},

	["npma_2022"] = {
		["model"] = "npa_trophy", ["bone"] = 18905, ["x"] = 0.1, ["y"] = 0.05, ["z"] = 0.0, ["xR"] = -85.0, ["yR"] = -80.0,
		["zR"] = -80.0
	},
	-- 18905 left hand - 57005 right hand
	["tvmic01"] = {
		["model"] = "p_ing_microphonel_01", ["bone"] = 18905, ["x"] = 0.1, ["y"] = 0.05, ["z"] = 0.0, ["xR"] = -85.0,
		["yR"] = -80.0, ["zR"] = -80.0
	},
	["props_news_mic"] = {
		["model"] = "props_news_mic", ["bone"] = 18905, ["x"] = 0.1, ["y"] = 0.06, ["z"] = 0.05, ["xR"] = -85.0, ["yR"] = -80.0,
		["zR"] = -80.0
	},

	["tvmic02"] = {
		["model"] = "p_ing_microphonel_01_lsbn", ["bone"] = 18905, ["x"] = 0.1, ["y"] = 0.05, ["z"] = 0.05, ["xR"] = -85.0,
		["yR"] = -80.0, ["zR"] = -80.0
	},

	["nosbottle"] = {
		["model"] = "p_cs_bottle_01", ["bone"] = 18905, ["x"] = 0.1, ["y"] = 0.05, ["z"] = 0.0, ["xR"] = -85.0, ["yR"] = -80.0,
		["zR"] = -80.0
	},

	["newspaper01"] = {
		["model"] = "prop_cliff_paper", ["bone"] = 28422, ["x"] = -0.07, ["y"] = 0.0, ["z"] = 0.0, ["xR"] = 90.0, ["yR"] = 0.0,
		["zR"] = 0.0
	},


	["golfbag01"] = {
		["model"] = "prop_golf_bag_01", ["bone"] = 24816, ["x"] = 0.12, ["y"] = -0.3, ["z"] = 0.0, ["xR"] = -75.0, ["yR"] = 190.0,
		["zR"] = 92.0
	},

	["golfputter01"] = {
		["model"] = "prop_golf_putter_01", ["bone"] = 57005, ["x"] = 0.0, ["y"] = -0.05, ["z"] = 0.0, ["xR"] = 90.0,
		["yR"] = -118.0, ["zR"] = 44.0
	},

	["golfiron01"] = {
		["model"] = "prop_golf_iron_01", ["bone"] = 57005, ["x"] = 0.125, ["y"] = 0.04, ["z"] = 0.0, ["xR"] = 90.0,
		["yR"] = -118.0, ["zR"] = 44.0
	},
	["golfiron03"] = {
		["model"] = "prop_golf_iron_01", ["bone"] = 57005, ["x"] = 0.126, ["y"] = 0.041, ["z"] = 0.0, ["xR"] = 90.0,
		["yR"] = -118.0, ["zR"] = 44.0
	},
	["golfiron05"] = {
		["model"] = "prop_golf_iron_01", ["bone"] = 57005, ["x"] = 0.127, ["y"] = 0.042, ["z"] = 0.0, ["xR"] = 90.0,
		["yR"] = -118.0, ["zR"] = 44.0
	},
	["golfiron07"] = {
		["model"] = "prop_golf_iron_01", ["bone"] = 57005, ["x"] = 0.128, ["y"] = 0.043, ["z"] = 0.0, ["xR"] = 90.0,
		["yR"] = -118.0, ["zR"] = 44.0
	},
	["golfwedge01"] = {
		["model"] = "prop_golf_pitcher_01", ["bone"] = 57005, ["x"] = 0.17, ["y"] = 0.04, ["z"] = 0.0, ["xR"] = 90.0,
		["yR"] = -118.0, ["zR"] = 44.0
	},

	["golfdriver01"] = {
		["model"] = "prop_golf_driver", ["bone"] = 57005, ["x"] = 0.14, ["y"] = 0.00, ["z"] = 0.0, ["xR"] = 160.0, ["yR"] = -60.0,
		["zR"] = 10.0
	},
...
AddEventHandler('attachItem69', function(item)
	TriggerEvent("attachProp69", attachPropList[item]["model"], attachPropList[item]["bone"], attachPropList[item]["x"],
		attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"], attachPropList[item]["yR"],
		attachPropList[item]["zR"])
end)

RegisterNetEvent('attachItemPhone')
AddEventHandler('attachItemPhone', function(item)
	TriggerEvent("attachPropPhone", attachPropList[item]["model"], attachPropList[item]["bone"],
		attachPropList[item]["x"], attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"],
		attachPropList[item]["yR"], attachPropList[item]["zR"])
end)

RegisterNetEvent('attachItemRadio')
AddEventHandler('attachItemRadio', function(item)
	TriggerEvent("attachPropRadio", attachPropList[item]["model"], attachPropList[item]["bone"],
		attachPropList[item]["x"], attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"],
		attachPropList[item]["yR"], attachPropList[item]["zR"])
end)
...
AddEventHandler('attachItemClipboard', function(item)
	TriggerEvent("attachPropClipboard", attachPropList[item]["model"], attachPropList[item]["bone"],
		attachPropList[item]["x"], attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"],
		attachPropList[item]["yR"], attachPropList[item]["zR"])
end)
...
AddEventHandler('attachItem', function(item)
	TriggerEvent("attachProp", attachPropList[item]["model"], attachPropList[item]["bone"], attachPropList[item]["x"],
		attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"], attachPropList[item]["yR"],
		attachPropList[item]["zR"], attachPropList[item]["vertexIndex"], attachPropList[item]["disableCollision"])
end)

RegisterNetEvent('attachItemPerm')
AddEventHandler('attachItemPerm', function(item)
	TriggerEvent("attachPropPerm", attachPropList[item]["model"], attachPropList[item]["bone"], attachPropList[item]
		["x"], attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"],
		attachPropList[item]["yR"],
		attachPropList[item]["zR"])
end)
...
AddEventHandler('np-propattach:attach', function(pPropItem, pTargetFunction)
	...
	TriggerEvent(targetFunction, attachPropList[pPropItem]["model"], attachPropList[pPropItem]["bone"],
		attachPropList[pPropItem]["x"], attachPropList[pPropItem]["y"], attachPropList[pPropItem]["z"],
		attachPropList[pPropItem]["xR"], attachPropList[pPropItem]["yR"], attachPropList[pPropItem]["zR"])
end)
...
AddEventHandler('animation:carry', function(item, isInventory)
	...
	if not carryingObject then
		...
		lastObjectHealth = 0
		TriggerEvent("attachcarryObject", attachPropList[item]["model"], attachPropList[item]["bone"],
			attachPropList[item]["x"], attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"],
			attachPropList[item]["yR"], attachPropList[item]["zR"])
	else
		holding = "none"
