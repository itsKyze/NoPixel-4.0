...
Config.Objects = {
	-- Flags
	[1] = {model = `np_pride_flag_01`}, -- lgbtqia+
	[2] = {model = `np_pride_flag_02`}, -- progress
	[3] = {model = `np_pride_flag_03`}, -- trans
	[4] = {model = `np_pride_flag_04`}, -- lesbian
	[5] = {model = `np_pride_flag_05`}, -- nonbinary
	[6] = {model = `np_pride_flag_06`}, -- genderfluid
	[7] = {model = `np_pride_flag_07`}, -- queer
	[8] = {model = `np_pride_flag_08`}, -- pansexual
	[9] = {model = `np_pride_flag_09`}, -- bisexual
