;
(function () {
  // config/build/sv_main.js - NoPixel 4.0 Config Resource
  // Provides GetModuleConfig export used by np-base and other resources
  ...
  // Used by: exports["config"]:GetModuleConfig("moduleName")
  // ============================================================
  ...
  // ============================================================
  // Export: SetModuleConfig (runtime override)
  // ============================================================
  ...
  // ============================================================
  // Net event: client can request config
  // ============================================================
  onNet("config:requestModule", moduleName => {
    const src = source;
    const cfg = moduleConfigs[moduleName] || {};
    // Only send safe/non-sensitive configs to client
