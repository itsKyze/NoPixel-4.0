        ...
        if dickheaddebug then
            ...
            if veh ~= 0 and veh ~= nil then
                ...
                if (IsControlJustPressed(0, 32) and not IsControlPressed(0, 18)) or IsControlJustReleased(0, 18) then
                    ...
                    vehicleAir = false
                    timestart = GetGameTimer()
                    startCoords = GetEntityCoords(veh)
                    qtr = 0
                    qtrmph = 0
                end
                ...
                if GetDistanceBetweenCoords(startCoords, GetEntityCoords(veh), true) > 400.0 and qtr == 0 then
                    qtr = accel / 1000
                    qtrmph = mph
                end
            ...
            drawTxt(1.0, 0.88, 0.4,0.4,0.80, "100mph: " .. hundredtwenty, 155, 155, 155, 255)

            drawTxt(1.0, 0.90, 0.4,0.4,0.80, "Qtr Mile: " .. qtr, 155, 155, 155, 255)
